    ...
    render() {
        ...
        if (this.props.jobs.length > 0) {
            ...
            jobs = myJobs.map((job, index) => {
                ...
                return <div className="col-sm-6" key={index}><div className="card" key={index}><Job title={job.title} type={job.type} description={job.description} key={index} />            Job Status: {jobSt}
